    ...
    >
      ...
      >
        <View style={{ flex: 1, paddingRight: SPACING.sm }}>
          {/*
            The only way back from any drill-down screen in the app. It was an
            11px Text with onPress: not a button to a screen reader, and far
            under the 44px target — so the one control a user needs to get

...
const QueuesPage = lazy(() =>
  import("./pages/admin/queues").then((m) => ({ default: m.QueuesPage })),
);
const MessageSimulatorPage = lazy(() =>
  import("./pages/admin/message-simulator").then((m) => ({ default: m.MessageSimulatorPage })),
);
...
const LabDispatchCreatePage = lazy(() =>
  import("./pages/lab/dispatch-create").then((m) => ({ default: m.LabDispatchCreatePage })),
);
...
const CampDetailPage = lazy(() =>
  import("./pages/camp/camp-detail-page").then((m) => ({ default: m.CampDetailPage })),
);
        ...
        <Suspense fallback={<PageSkeleton />}>
          <Routes>
            ...
            >
              ...
              <Route path="admin/message-simulator" element={<MessageSimulatorPage />} />
              ...
              <Route path="lab/dispatch/new" element={<LabDispatchCreatePage />} />

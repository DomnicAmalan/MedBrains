// Billing BillingPageInner — split from billing.tsx (pure move).
...
import { DataTable, OperationalSignal, PageHeader } from "@/components";
...
import {
  ...
  GstTdsTab,
  JournalEntriesTab,
} from "./accounting-tabs";
import { AdvancesTab } from "./advances";
import { AuditLogTab } from "./audit-log";
import { ChargeMasterTab } from "./charge-master";
...
import { BillingSettingsTab } from "./settings";
import {

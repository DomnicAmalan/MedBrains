// Consent TemplatesTab — split from consent.tsx (pure move).

import { Center, Code, Drawer, Group, Loader, Select, Text } from "@mantine/core";
...
import { MedicoLegalOpinionForm } from "./medico-legal-opinion-form";

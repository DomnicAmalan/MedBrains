...
const PRINT_ROUTING_REQUIREMENTS: readonly PrintRoutingRequirement[] = [
  ...
  },
  {
    ...
    requiredCopies: ["customer"],
    printerProfiles: ["opd-token-thermal"],
    format: "thermal_80mm",
  ...
  },
  {
    ...
    requiredCopies: ["customer", "office", "mrd"],
    printerProfiles: ["opd-summary", "opd-a4"],
    format: "a4_portrait",
  ...
  },
  {
    ...
    requiredCopies: ["customer", "pharmacy"],
  ...
  },
  {
    ...
    requiredCopies: ["office", "clinical", "mrd"],
    printerProfiles: ["ipd-a4", "consent-a4"],
    format: "a4_portrait",
  ...
  },
  {
    ...
    requiredCopies: ["office", "police", "mrd", "duplicate"],
  ...
  },
  {
    ...
    requiredCopies: ["mrd", "office", "duplicate"],

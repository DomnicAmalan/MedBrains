...
pub struct DayEndClose {
    ...
    pub actual_card: rust_decimal::Decimal,
    pub actual_upi: rust_decimal::Decimal,
    pub card_difference: rust_decimal::Decimal,
    pub upi_difference: rust_decimal::Decimal,

...
CREATE TABLE public.bank_transaction_claim_allocations (
...
-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocat_bank_transaction_id_claim_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocat_bank_transaction_id_claim_id_key UNIQUE (bank_transaction_id, claim_id);

-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocations_pkey PRIMARY KEY (id);

CREATE INDEX idx_bank_alloc_claim ON public.bank_transaction_claim_allocations USING btree (claim_id);

CREATE INDEX idx_bank_alloc_tenant ON public.bank_transaction_claim_allocations USING btree (tenant_id);

CREATE INDEX idx_bank_transaction_claim_allocations_deleted_at_3cfeb068 ON public.bank_transaction_claim_allocations USING btree (deleted_at);

ALTER TABLE public.bank_transaction_claim_allocations ENABLE ROW LEVEL SECURITY;

-- Name: bank_transaction_claim_allocations tenant_isolation_bank_transaction_claim_allocations; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY tenant_isolation_bank_transaction_claim_allocations ON public.bank_transaction_claim_allocations USING (((tenant_id)::text = current_setting('app.tenant_id'::text, true))) WITH CHECK (((tenant_id)::text = current_setting('app.tenant_id'::text, true)));

-- Name: bank_transaction_claim_allocations trg_bank_transaction_claim_allocations_soft_delete_3cfeb068; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_bank_transaction_claim_allocations_soft_delete_3cfeb068 BEFORE DELETE ON public.bank_transaction_claim_allocations FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.insurance_claims (
    ...
    nhcx_request_id text,
    nhcx_correlation uuid,
    nhcx_submitted_at timestamp with time zone,
    nhcx_outcome text,
    nhcx_disposition text,
    nhcx_correlation_id uuid,
    nhcx_api_call_id uuid,
    nhcx_recipient_code text,
    nhcx_response_payload jsonb,
    nhcx_response_at timestamp with time zone,
    admission_id uuid,
    insurance_id uuid,
    total_bill_amount numeric DEFAULT 0 NOT NULL,
    deductions numeric DEFAULT 0 NOT NULL,
    patient_payable numeric DEFAULT 0 NOT NULL,
    deleted_at timestamp with time zone,
    deleted_by uuid,
    delete_reason text,
    nhcx_status text,
    CONSTRAINT insurance_claims_status_check CHECK ((status = ANY (ARRAY['initiated'::text, 'pre_auth_requested'::text, 'pre_auth_approved'::text, 'pre_auth_rejected'::text, 'claim_submitted'::text, 'claim_approved'::text, 'claim_rejected'::text, 'settled'::text, 'partially_settled'::text])))
);
...
CREATE INDEX idx_insurance_claims_deleted_at_c3519ab2 ON public.insurance_claims USING btree (deleted_at);

CREATE INDEX idx_insurance_claims_invoice ON public.insurance_claims USING btree (invoice_id);

CREATE INDEX idx_insurance_claims_nhcx_correlation ON public.insurance_claims USING btree (nhcx_correlation) WHERE (nhcx_correlation IS NOT NULL);
...
CREATE INDEX idx_insurance_claims_tenant_status ON public.insurance_claims USING btree (tenant_id, status);
...
-- Name: insurance_claims trg_insurance_claims_soft_delete_c3519ab2; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_insurance_claims_soft_delete_c3519ab2 BEFORE DELETE ON public.insurance_claims FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_insurance_verifications_deleted_at_8231e7bc ON public.insurance_verifications USING btree (deleted_at);

CREATE INDEX idx_insurance_verifications_patient_id ON public.insurance_verifications USING btree (patient_id);
...
-- Name: insurance_verifications trg_insurance_verifications_soft_delete_8231e7bc; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_insurance_verifications_soft_delete_8231e7bc BEFORE DELETE ON public.insurance_verifications FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_master_insurance_providers_deleted_at_4387f31d ON public.master_insurance_providers USING btree (deleted_at);
...
-- Name: master_insurance_providers trg_master_insurance_providers_soft_delete_4387f31d; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_master_insurance_providers_soft_delete_4387f31d BEFORE DELETE ON public.master_insurance_providers FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pa_requirement_rules_deleted_at_1172e0ff ON public.pa_requirement_rules USING btree (deleted_at);
...
-- Name: pa_requirement_rules trg_pa_requirement_rules_soft_delete_1172e0ff; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pa_requirement_rules_soft_delete_1172e0ff BEFORE DELETE ON public.pa_requirement_rules FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_patient_insurance_deleted_at_ee4cf627 ON public.patient_insurance USING btree (deleted_at);

CREATE INDEX idx_patient_insurance_patient ON public.patient_insurance USING btree (tenant_id, patient_id);

CREATE INDEX idx_patient_insurance_patient_id ON public.patient_insurance USING btree (patient_id);
...
-- Name: patient_insurance trg_patient_insurance_soft_delete_ee4cf627; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_patient_insurance_soft_delete_ee4cf627 BEFORE DELETE ON public.patient_insurance FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pre_authorization_requests_deleted_at_31c588e8 ON public.pre_authorization_requests USING btree (deleted_at);

CREATE INDEX idx_pre_authorization_requests_encounter_id ON public.pre_authorization_requests USING btree (encounter_id);

CREATE INDEX idx_pre_authorization_requests_patient_id ON public.pre_authorization_requests USING btree (patient_id);
...
-- Name: pre_authorization_requests trg_pre_authorization_requests_soft_delete_31c588e8; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pre_authorization_requests_soft_delete_31c588e8 BEFORE DELETE ON public.pre_authorization_requests FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prior_auth_appeals_deleted_at_cac3e616 ON public.prior_auth_appeals USING btree (deleted_at);
...
-- Name: prior_auth_appeals trg_prior_auth_appeals_soft_delete_cac3e616; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prior_auth_appeals_soft_delete_cac3e616 BEFORE DELETE ON public.prior_auth_appeals FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prior_auth_documents_deleted_at_c5d3a663 ON public.prior_auth_documents USING btree (deleted_at);
...
-- Name: prior_auth_documents trg_prior_auth_documents_soft_delete_c5d3a663; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prior_auth_documents_soft_delete_c5d3a663 BEFORE DELETE ON public.prior_auth_documents FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prior_auth_nhcx_correlation ON public.prior_auth_requests USING btree (nhcx_correlation_id) WHERE (nhcx_correlation_id IS NOT NULL);

CREATE INDEX idx_prior_auth_requests_deleted_at_f0222dd0 ON public.prior_auth_requests USING btree (deleted_at);

CREATE INDEX idx_prior_auth_requests_department_id ON public.prior_auth_requests USING btree (department_id);

CREATE INDEX idx_prior_auth_requests_invoice_id ON public.prior_auth_requests USING btree (invoice_id);

CREATE INDEX idx_prior_auth_requests_patient_id ON public.prior_auth_requests USING btree (patient_id);
...
-- Name: prior_auth_requests trg_prior_auth_requests_soft_delete_f0222dd0; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prior_auth_requests_soft_delete_f0222dd0 BEFORE DELETE ON public.prior_auth_requests FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prior_auth_status_log_deleted_at_74dbd910 ON public.prior_auth_status_log USING btree (deleted_at);
...
-- Name: prior_auth_status_log trg_prior_auth_status_log_soft_delete_74dbd910; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prior_auth_status_log_soft_delete_74dbd910 BEFORE DELETE ON public.prior_auth_status_log FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_ur_payer_communications_deleted_at_32e161cf ON public.ur_payer_communications USING btree (deleted_at);
...
-- Name: ur_payer_communications trg_ur_payer_communications_soft_delete_32e161cf; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_ur_payer_communications_soft_delete_32e161cf BEFORE DELETE ON public.ur_payer_communications FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_ur_status_conversions_admission_id ON public.ur_status_conversions USING btree (admission_id);

CREATE INDEX idx_ur_status_conversions_deleted_at_83b296b8 ON public.ur_status_conversions USING btree (deleted_at);
...
-- Name: ur_status_conversions trg_ur_status_conversions_soft_delete_83b296b8; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_ur_status_conversions_soft_delete_83b296b8 BEFORE DELETE ON public.ur_status_conversions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_utilization_reviews_admission_id ON public.utilization_reviews USING btree (admission_id);

CREATE INDEX idx_utilization_reviews_deleted_at_a134a5fd ON public.utilization_reviews USING btree (deleted_at);

CREATE INDEX idx_utilization_reviews_patient_id ON public.utilization_reviews USING btree (patient_id);
...
-- Name: utilization_reviews trg_utilization_reviews_soft_delete_a134a5fd; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_utilization_reviews_soft_delete_a134a5fd BEFORE DELETE ON public.utilization_reviews FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();

-- ── foreign keys within this module ─────────────────────────────────
-- Declared last so the tables above can appear in any order.

-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocations_claim_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocations_claim_id_fkey FOREIGN KEY (claim_id) REFERENCES public.insurance_claims(id);

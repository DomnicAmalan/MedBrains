...
CREATE INDEX idx_adherence_records_appointment_id ON public.adherence_records USING btree (appointment_id);

CREATE INDEX idx_adherence_records_deleted_at_5d5eb309 ON public.adherence_records USING btree (deleted_at);

CREATE INDEX idx_adherence_records_patient_id ON public.adherence_records USING btree (patient_id);
...
-- Name: adherence_records trg_adherence_records_soft_delete_5d5eb309; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_adherence_records_soft_delete_5d5eb309 BEFORE DELETE ON public.adherence_records FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_drug_interactions_deleted_at_fa04dd44 ON public.drug_interactions USING btree (deleted_at);
...
-- Name: drug_interactions trg_drug_interactions_soft_delete_fa04dd44; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_drug_interactions_soft_delete_fa04dd44 BEFORE DELETE ON public.drug_interactions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_allergy_check_log_catalog_item_id ON public.pharmacy_allergy_check_log USING btree (catalog_item_id);

CREATE INDEX idx_pharmacy_allergy_check_log_deleted_at_f4a04f7d ON public.pharmacy_allergy_check_log USING btree (deleted_at);

CREATE INDEX idx_pharmacy_allergy_check_log_order_id ON public.pharmacy_allergy_check_log USING btree (order_id);

CREATE INDEX idx_pharmacy_allergy_check_log_tenant_id ON public.pharmacy_allergy_check_log USING btree (tenant_id);
...
-- Name: pharmacy_allergy_check_log trg_pharmacy_allergy_check_log_soft_delete_f4a04f7d; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_allergy_check_log_soft_delete_f4a04f7d BEFORE DELETE ON public.pharmacy_allergy_check_log FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_batches_catalog_item_id ON public.pharmacy_batches USING btree (catalog_item_id);

CREATE INDEX idx_pharmacy_batches_deleted_at_8baef4b8 ON public.pharmacy_batches USING btree (deleted_at);
...
-- Name: pharmacy_batches trg_pharmacy_batches_soft_delete_8baef4b8; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_batches_soft_delete_8baef4b8 BEFORE DELETE ON public.pharmacy_batches FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_cash_drawers_deleted_at_cf29a3c9 ON public.pharmacy_cash_drawers USING btree (deleted_at);
...
-- Name: pharmacy_cash_drawers trg_pharmacy_cash_drawers_soft_delete_cf29a3c9; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_cash_drawers_soft_delete_cf29a3c9 BEFORE DELETE ON public.pharmacy_cash_drawers FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_cash_float_movements_deleted_at_877b074a ON public.pharmacy_cash_float_movements USING btree (deleted_at);

CREATE INDEX idx_pharmacy_cash_float_movements_tenant_id ON public.pharmacy_cash_float_movements USING btree (tenant_id);
...
-- Name: pharmacy_cash_float_movements trg_pharmacy_cash_float_movements_soft_delete_877b074a; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_cash_float_movements_soft_delete_877b074a BEFORE DELETE ON public.pharmacy_cash_float_movements FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_cashier_overrides_deleted_at_7fbc0158 ON public.pharmacy_cashier_overrides USING btree (deleted_at);
...
-- Name: pharmacy_cashier_overrides trg_pharmacy_cashier_overrides_soft_delete_7fbc0158; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_cashier_overrides_soft_delete_7fbc0158 BEFORE DELETE ON public.pharmacy_cashier_overrides FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_catalog_deleted_at_eeb582c6 ON public.pharmacy_catalog USING btree (deleted_at);
...
CREATE UNIQUE INDEX uq_pharmacy_catalog_barcode ON public.pharmacy_catalog USING btree (tenant_id, barcode) WHERE (barcode IS NOT NULL);

CREATE UNIQUE INDEX uq_pharmacy_catalog_tenant_code_active ON public.pharmacy_catalog USING btree (tenant_id, code) WHERE is_active;
...
-- Name: pharmacy_catalog trg_pharmacy_catalog_soft_delete_eeb582c6; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_catalog_soft_delete_eeb582c6 BEFORE DELETE ON public.pharmacy_catalog FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();

-- Name: COLUMN pharmacy_catalog.barcode; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.pharmacy_catalog.barcode IS 'GTIN/EAN-13 or other pack barcode identifying the product. Batch and expiry are not encoded here — they live on pharmacy_batches.';
...
CREATE INDEX idx_pharmacy_counseling_deleted_at_ae0defa0 ON public.pharmacy_counseling USING btree (deleted_at);
...
-- Name: pharmacy_counseling trg_pharmacy_counseling_soft_delete_ae0defa0; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_counseling_soft_delete_ae0defa0 BEFORE DELETE ON public.pharmacy_counseling FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_coverage_checks_deleted_at_1e69055f ON public.pharmacy_coverage_checks USING btree (deleted_at);
...
-- Name: pharmacy_coverage_checks trg_pharmacy_coverage_checks_soft_delete_1e69055f; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_coverage_checks_soft_delete_1e69055f BEFORE DELETE ON public.pharmacy_coverage_checks FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_credit_notes_deleted_at_8468fe44 ON public.pharmacy_credit_notes USING btree (deleted_at);
...
-- Name: pharmacy_credit_notes trg_pharmacy_credit_notes_soft_delete_8468fe44; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_credit_notes_soft_delete_8468fe44 BEFORE DELETE ON public.pharmacy_credit_notes FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_day_settlements_deleted_at_0484ac26 ON public.pharmacy_day_settlements USING btree (deleted_at);
...
-- Name: pharmacy_day_settlements trg_pharmacy_day_settlements_soft_delete_0484ac26; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_day_settlements_soft_delete_0484ac26 BEFORE DELETE ON public.pharmacy_day_settlements FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_destruction_log_deleted_at_9e146ac7 ON public.pharmacy_destruction_log USING btree (deleted_at);
...
-- Name: pharmacy_destruction_log trg_pharmacy_destruction_log_soft_delete_9e146ac7; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_destruction_log_soft_delete_9e146ac7 BEFORE DELETE ON public.pharmacy_destruction_log FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_drug_margin_daily_deleted_at_dc844a60 ON public.pharmacy_drug_margin_daily USING btree (deleted_at);
...
-- Name: pharmacy_drug_margin_daily trg_pharmacy_drug_margin_daily_soft_delete_dc844a60; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_drug_margin_daily_soft_delete_dc844a60 BEFORE DELETE ON public.pharmacy_drug_margin_daily FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_drug_recalls_deleted_at_c8e62375 ON public.pharmacy_drug_recalls USING btree (deleted_at);
...
-- Name: pharmacy_drug_recalls trg_pharmacy_drug_recalls_soft_delete_c8e62375; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_drug_recalls_soft_delete_c8e62375 BEFORE DELETE ON public.pharmacy_drug_recalls FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_emergency_kits_deleted_at_2d59febe ON public.pharmacy_emergency_kits USING btree (deleted_at);

CREATE INDEX idx_pharmacy_emergency_kits_department_id ON public.pharmacy_emergency_kits USING btree (department_id);

CREATE INDEX idx_pharmacy_emergency_kits_location_id ON public.pharmacy_emergency_kits USING btree (location_id);

CREATE INDEX idx_pharmacy_emergency_kits_tenant_id ON public.pharmacy_emergency_kits USING btree (tenant_id);
...
-- Name: pharmacy_emergency_kits trg_pharmacy_emergency_kits_soft_delete_2d59febe; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_emergency_kits_soft_delete_2d59febe BEFORE DELETE ON public.pharmacy_emergency_kits FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_free_dispensings_deleted_at_8be2e596 ON public.pharmacy_free_dispensings USING btree (deleted_at);
...
-- Name: pharmacy_free_dispensings trg_pharmacy_free_dispensings_soft_delete_8be2e596; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_free_dispensings_soft_delete_8be2e596 BEFORE DELETE ON public.pharmacy_free_dispensings FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_ndps_register_catalog_item_id ON public.pharmacy_ndps_register USING btree (catalog_item_id);

CREATE INDEX idx_pharmacy_ndps_register_deleted_at_eec5061e ON public.pharmacy_ndps_register USING btree (deleted_at);

CREATE INDEX idx_pharmacy_ndps_register_patient_id ON public.pharmacy_ndps_register USING btree (patient_id);
...
-- Name: pharmacy_ndps_register trg_pharmacy_ndps_register_soft_delete_eec5061e; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_ndps_register_soft_delete_eec5061e BEFORE DELETE ON public.pharmacy_ndps_register FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_order_items_active_order ON public.pharmacy_order_items USING btree (tenant_id, order_id) WHERE (removed_at IS NULL);

CREATE INDEX idx_pharmacy_order_items_batch_stock ON public.pharmacy_order_items USING btree (batch_stock_id);

CREATE INDEX idx_pharmacy_order_items_catalog_item_id ON public.pharmacy_order_items USING btree (catalog_item_id);

CREATE INDEX idx_pharmacy_order_items_deleted_at_9dbdbb35 ON public.pharmacy_order_items USING btree (deleted_at);

CREATE INDEX idx_pharmacy_order_items_order ON public.pharmacy_order_items USING btree (order_id);

CREATE INDEX idx_pharmacy_order_items_removed ON public.pharmacy_order_items USING btree (tenant_id, removed_at) WHERE (removed_at IS NOT NULL);
...
-- Name: pharmacy_order_items trg_pharmacy_order_items_soft_delete_9dbdbb35; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_order_items_soft_delete_9dbdbb35 BEFORE DELETE ON public.pharmacy_order_items FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.pharmacy_orders (
    ...
    CONSTRAINT pharmacy_orders_status_check CHECK ((status = ANY (ARRAY['ordered'::text, 'dispensed'::text, 'partially_dispensed'::text, 'cancelled'::text, 'returned'::text])))
);
...
CREATE INDEX idx_pharmacy_orders_deleted_at_eaf5119d ON public.pharmacy_orders USING btree (deleted_at);

CREATE INDEX idx_pharmacy_orders_dispensing_type ON public.pharmacy_orders USING btree (tenant_id, dispensing_type);

CREATE INDEX idx_pharmacy_orders_encounter_id ON public.pharmacy_orders USING btree (encounter_id);

CREATE INDEX idx_pharmacy_orders_live ON public.pharmacy_orders USING btree (tenant_id, patient_id) WHERE (is_dummy = false);
...
CREATE INDEX idx_pharmacy_orders_prescription_id ON public.pharmacy_orders USING btree (prescription_id);
...
-- Name: pharmacy_orders trg_pharmacy_orders_soft_delete_eaf5119d; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_orders_soft_delete_eaf5119d BEFORE DELETE ON public.pharmacy_orders FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_payment_transactions_deleted_at_137be2eb ON public.pharmacy_payment_transactions USING btree (deleted_at);

CREATE INDEX idx_pharmacy_payment_transactions_invoice_id ON public.pharmacy_payment_transactions USING btree (invoice_id);

CREATE INDEX idx_pharmacy_payment_transactions_order_id ON public.pharmacy_payment_transactions USING btree (order_id);
...
-- Name: pharmacy_payment_transactions trg_pharmacy_payment_transactions_soft_delete_137be2eb; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_payment_transactions_soft_delete_137be2eb BEFORE DELETE ON public.pharmacy_payment_transactions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_petty_cash_vouchers_deleted_at_7b09ecd4 ON public.pharmacy_petty_cash_vouchers USING btree (deleted_at);
...
-- Name: pharmacy_petty_cash_vouchers trg_pharmacy_petty_cash_vouchers_soft_delete_7b09ecd4; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_petty_cash_vouchers_soft_delete_7b09ecd4 BEFORE DELETE ON public.pharmacy_petty_cash_vouchers FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_pos_sale_items_catalog_item_id ON public.pharmacy_pos_sale_items USING btree (catalog_item_id);

CREATE INDEX idx_pharmacy_pos_sale_items_deleted_at_b535534d ON public.pharmacy_pos_sale_items USING btree (deleted_at);

CREATE INDEX idx_pharmacy_pos_sale_items_tenant_id ON public.pharmacy_pos_sale_items USING btree (tenant_id);
...
-- Name: pharmacy_pos_sale_items trg_pharmacy_pos_sale_items_soft_delete_b535534d; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_pos_sale_items_soft_delete_b535534d BEFORE DELETE ON public.pharmacy_pos_sale_items FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.pharmacy_pos_sales (
    ...
    billing_posted_at timestamp with time zone,
    deleted_at timestamp with time zone,
    deleted_by uuid,
    delete_reason text,
...
CREATE INDEX idx_pharmacy_pos_sales_billing_invoice ON public.pharmacy_pos_sales USING btree (tenant_id, billing_invoice_id) WHERE (billing_invoice_id IS NOT NULL);

CREATE INDEX idx_pharmacy_pos_sales_deleted_at_93c83a5d ON public.pharmacy_pos_sales USING btree (deleted_at);
...
-- Name: pharmacy_pos_sales trg_pharmacy_pos_sales_soft_delete_93c83a5d; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_pos_sales_soft_delete_93c83a5d BEFORE DELETE ON public.pharmacy_pos_sales FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_prescriptions_deleted_at_7ebb2ac5 ON public.pharmacy_prescriptions USING btree (deleted_at);

CREATE INDEX idx_pharmacy_prescriptions_doctor_id ON public.pharmacy_prescriptions USING btree (doctor_id);

CREATE INDEX idx_pharmacy_prescriptions_encounter_id ON public.pharmacy_prescriptions USING btree (encounter_id);

CREATE INDEX idx_pharmacy_prescriptions_patient_id ON public.pharmacy_prescriptions USING btree (patient_id);
...
-- Name: pharmacy_prescriptions trg_pharmacy_prescriptions_soft_delete_7ebb2ac5; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_prescriptions_soft_delete_7ebb2ac5 BEFORE DELETE ON public.pharmacy_prescriptions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_pricing_tiers_deleted_at_3f00c1fb ON public.pharmacy_pricing_tiers USING btree (deleted_at);
...
-- Name: pharmacy_pricing_tiers trg_pharmacy_pricing_tiers_soft_delete_3f00c1fb; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_pricing_tiers_soft_delete_3f00c1fb BEFORE DELETE ON public.pharmacy_pricing_tiers FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_repeats_deleted_at_a2560230 ON public.pharmacy_repeats USING btree (deleted_at);

CREATE INDEX idx_pharmacy_repeats_prescription_id ON public.pharmacy_repeats USING btree (prescription_id);
...
-- Name: pharmacy_repeats trg_pharmacy_repeats_soft_delete_a2560230; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_repeats_soft_delete_a2560230 BEFORE DELETE ON public.pharmacy_repeats FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_returns_deleted_at_3ed6c576 ON public.pharmacy_returns USING btree (deleted_at);

CREATE INDEX idx_pharmacy_returns_patient_id ON public.pharmacy_returns USING btree (patient_id);
...
-- Name: pharmacy_returns trg_pharmacy_returns_soft_delete_3ed6c576; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_returns_soft_delete_3ed6c576 BEFORE DELETE ON public.pharmacy_returns FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_stock_reconciliation_deleted_at_57e9f2e0 ON public.pharmacy_stock_reconciliation USING btree (deleted_at);

CREATE INDEX idx_pharmacy_stock_reconciliation_tenant_id ON public.pharmacy_stock_reconciliation USING btree (tenant_id);
...
-- Name: pharmacy_stock_reconciliation trg_pharmacy_stock_reconciliation_soft_delete_57e9f2e0; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_stock_reconciliation_soft_delete_57e9f2e0 BEFORE DELETE ON public.pharmacy_stock_reconciliation FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_stock_transactions_deleted_at_4b323fb0 ON public.pharmacy_stock_transactions USING btree (deleted_at);

CREATE INDEX idx_pharmacy_stock_transactions_tenant_id ON public.pharmacy_stock_transactions USING btree (tenant_id);
...
-- Name: pharmacy_stock_transactions trg_pharmacy_stock_transactions_soft_delete_4b323fb0; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_stock_transactions_soft_delete_4b323fb0 BEFORE DELETE ON public.pharmacy_stock_transactions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_store_assignments_deleted_at_1a9c3e1e ON public.pharmacy_store_assignments USING btree (deleted_at);
...
-- Name: pharmacy_store_assignments trg_pharmacy_store_assignments_soft_delete_1a9c3e1e; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_store_assignments_soft_delete_1a9c3e1e BEFORE DELETE ON public.pharmacy_store_assignments FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_store_indents_deleted_at_951c10f4 ON public.pharmacy_store_indents USING btree (deleted_at);
...
-- Name: pharmacy_store_indents trg_pharmacy_store_indents_soft_delete_951c10f4; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_store_indents_soft_delete_951c10f4 BEFORE DELETE ON public.pharmacy_store_indents FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_substitutes_deleted_at_811e1a72 ON public.pharmacy_substitutes USING btree (deleted_at);
...
-- Name: pharmacy_substitutes trg_pharmacy_substitutes_soft_delete_811e1a72; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_substitutes_soft_delete_811e1a72 BEFORE DELETE ON public.pharmacy_substitutes FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_substitutions_deleted_at_16c75404 ON public.pharmacy_substitutions USING btree (deleted_at);
...
-- Name: pharmacy_substitutions trg_pharmacy_substitutions_soft_delete_16c75404; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_substitutions_soft_delete_16c75404 BEFORE DELETE ON public.pharmacy_substitutions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_pharmacy_supplier_payments_deleted_at_b2bcf60b ON public.pharmacy_supplier_payments USING btree (deleted_at);
...
-- Name: pharmacy_supplier_payments trg_pharmacy_supplier_payments_soft_delete_b2bcf60b; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_supplier_payments_soft_delete_b2bcf60b BEFORE DELETE ON public.pharmacy_supplier_payments FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.pharmacy_transfer_requests (
    ...
    deleted_by uuid,
    delete_reason text,
    dispatched_lines jsonb DEFAULT '[]'::jsonb NOT NULL,
    dispatched_by uuid,
    dispatched_at timestamp with time zone,
    received_by uuid,
    received_at timestamp with time zone,
    CONSTRAINT pharmacy_transfer_requests_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'approved'::text, 'dispatched'::text, 'received'::text, 'transferred'::text, 'cancelled'::text])))
);
...
CREATE INDEX idx_pharmacy_transfer_requests_deleted_at_6ad28de9 ON public.pharmacy_transfer_requests USING btree (deleted_at);
...
-- Name: pharmacy_transfer_requests trg_pharmacy_transfer_requests_soft_delete_6ad28de9; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_pharmacy_transfer_requests_soft_delete_6ad28de9 BEFORE DELETE ON public.pharmacy_transfer_requests FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prescription_items_catalog_item_id ON public.prescription_items USING btree (catalog_item_id);

CREATE INDEX idx_prescription_items_deleted_at_9de9ad5e ON public.prescription_items USING btree (deleted_at);
...
-- Name: prescription_items trg_prescription_items_soft_delete_9de9ad5e; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prescription_items_soft_delete_9de9ad5e BEFORE DELETE ON public.prescription_items FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_prescription_templates_deleted_at_accd83df ON public.prescription_templates USING btree (deleted_at);

CREATE INDEX idx_prescription_templates_department_id ON public.prescription_templates USING btree (department_id);
...
-- Name: prescription_templates trg_prescription_templates_soft_delete_accd83df; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prescription_templates_soft_delete_accd83df BEFORE DELETE ON public.prescription_templates FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.prescriptions (
    ...
    deleted_by uuid,
    delete_reason text,
    order_mode text DEFAULT 'written'::text NOT NULL,
    transcribed_by uuid,
    read_back_confirmed boolean DEFAULT false NOT NULL,
    countersign_due_at timestamp with time zone,
    countersign_escalated_at timestamp with time zone,
    countersign_escalated_to uuid,
    CONSTRAINT prescriptions_order_mode_check CHECK ((order_mode = ANY (ARRAY['written'::text, 'verbal'::text, 'telephone'::text]))),
...
CREATE INDEX idx_prescriptions_countersign_escalation ON public.prescriptions USING btree (tenant_id, countersign_due_at) WHERE ((order_mode <> 'written'::text) AND (NOT is_signed) AND (countersign_escalated_at IS NULL));

CREATE INDEX idx_prescriptions_deleted_at_f0b231c0 ON public.prescriptions USING btree (deleted_at);
...
CREATE INDEX idx_prescriptions_pending_countersign ON public.prescriptions USING btree (tenant_id, doctor_id, countersign_due_at) WHERE ((order_mode <> 'written'::text) AND (NOT is_signed));
...
-- Name: prescriptions trg_prescriptions_soft_delete_f0b231c0; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_prescriptions_soft_delete_f0b231c0 BEFORE DELETE ON public.prescriptions FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE INDEX idx_restricted_drug_approvals_catalog_item_id ON public.restricted_drug_approvals USING btree (catalog_item_id);

CREATE INDEX idx_restricted_drug_approvals_deleted_at_a27cc460 ON public.restricted_drug_approvals USING btree (deleted_at);

CREATE INDEX idx_restricted_drug_approvals_encounter ON public.restricted_drug_approvals USING btree (encounter_id);

CREATE INDEX idx_restricted_drug_approvals_patient_id ON public.restricted_drug_approvals USING btree (patient_id);

CREATE INDEX idx_restricted_drug_approvals_prescription_id ON public.restricted_drug_approvals USING btree (prescription_id);
...
-- Name: restricted_drug_approvals trg_restricted_drug_approvals_soft_delete_a27cc460; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_restricted_drug_approvals_soft_delete_a27cc460 BEFORE DELETE ON public.restricted_drug_approvals FOR EACH ROW EXECUTE FUNCTION public.soft_delete_guardrail();
...
CREATE TABLE public.user_pharmacy_assignments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
...
-- Name: user_pharmacy_assignments user_pharmacy_assignments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_pharmacy_assignments
    ADD CONSTRAINT user_pharmacy_assignments_pkey PRIMARY KEY (id);

-- Name: user_pharmacy_assignments user_pharmacy_assignments_user_id_store_location_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_pharmacy_assignments
    ADD CONSTRAINT user_pharmacy_assignments_user_id_store_location_id_key UNIQUE (user_id, store_location_id);

CREATE INDEX idx_user_pharmacy_assignments_location ON public.user_pharmacy_assignments USING btree (tenant_id, store_location_id);

CREATE INDEX idx_user_pharmacy_assignments_user ON public.user_pharmacy_assignments USING btree (tenant_id, user_id);

ALTER TABLE public.user_pharmacy_assignments ENABLE ROW LEVEL SECURITY;

-- Name: user_pharmacy_assignments user_pharmacy_assignments_tenant_isolation; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY user_pharmacy_assignments_tenant_isolation ON public.user_pharmacy_assignments USING ((tenant_id = (current_setting('app.tenant_id'::text, true))::uuid));
...
ALTER TABLE ONLY public.pharmacy_order_items
    ADD CONSTRAINT pharmacy_order_items_batch_stock_id_fkey FOREIGN KEY (batch_stock_id) REFERENCES public.pharmacy_batches(id);

...
ALTER TABLE ONLY public.abdm_gateway_callbacks
    ADD CONSTRAINT abdm_gateway_callbacks_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: abdm_hfr_registrations abdm_hfr_registrations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.abdm_hfr_registrations
    ADD CONSTRAINT abdm_hfr_registrations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: admissions admissions_er_visit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.admissions
    ADD CONSTRAINT admissions_er_visit_id_fkey FOREIGN KEY (er_visit_id) REFERENCES public.er_visits(id);
...
-- Name: advance_directives advance_directives_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.advance_directives
    ADD CONSTRAINT advance_directives_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: asset_classifications asset_classifications_asset_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_classifications
    ADD CONSTRAINT asset_classifications_asset_category_id_fkey FOREIGN KEY (asset_category_id) REFERENCES public.asset_categories(id);
...
-- Name: audit_log_legacy audit_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: audit_log_legacy audit_log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocations_bank_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocations_bank_transaction_id_fkey FOREIGN KEY (bank_transaction_id) REFERENCES public.bank_transactions(id) ON DELETE CASCADE;

-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocations_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocations_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: bank_transaction_claim_allocations bank_transaction_claim_allocations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transaction_claim_allocations
    ADD CONSTRAINT bank_transaction_claim_allocations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: bank_transactions bank_transactions_matched_claim_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bank_transactions
    ADD CONSTRAINT bank_transactions_matched_claim_id_fkey FOREIGN KEY (matched_claim_id) REFERENCES public.insurance_claims(id);
...
-- Name: bereavement_followups bereavement_followups_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bereavement_followups
    ADD CONSTRAINT bereavement_followups_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: camp_asset_reservations camp_asset_reservations_camp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_asset_reservations
    ADD CONSTRAINT camp_asset_reservations_camp_id_fkey FOREIGN KEY (camp_id) REFERENCES public.camps(id) ON DELETE RESTRICT;

-- Name: camp_asset_reservations camp_asset_reservations_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_asset_reservations
    ADD CONSTRAINT camp_asset_reservations_category_id_fkey FOREIGN KEY (asset_category_id) REFERENCES public.asset_categories(id);
...
-- Name: camp_department_counters camp_department_counters_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_department_counters
    ADD CONSTRAINT camp_department_counters_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id);
...
-- Name: camp_medicine_pricing_rules camp_medicine_pricing_rules_batch_stock_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_medicine_pricing_rules
    ADD CONSTRAINT camp_medicine_pricing_rules_batch_stock_id_fkey FOREIGN KEY (batch_stock_id) REFERENCES public.pharmacy_batches(id);

-- Name: camp_medicine_pricing_rules camp_medicine_pricing_rules_catalog_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_medicine_pricing_rules
    ADD CONSTRAINT camp_medicine_pricing_rules_catalog_item_id_fkey FOREIGN KEY (catalog_item_id) REFERENCES public.pharmacy_catalog(id);

-- Name: camp_medicine_pricing_rules camp_medicine_pricing_rules_store_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_medicine_pricing_rules
    ADD CONSTRAINT camp_medicine_pricing_rules_store_location_id_fkey FOREIGN KEY (store_location_id) REFERENCES public.store_locations(id);

-- Name: camp_registrations camp_registrations_attending_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_registrations
    ADD CONSTRAINT camp_registrations_attending_doctor_id_fkey FOREIGN KEY (attending_doctor_id) REFERENCES public.users(id);

-- Name: camp_registrations camp_registrations_clinical_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_registrations
    ADD CONSTRAINT camp_registrations_clinical_department_id_fkey FOREIGN KEY (clinical_department_id) REFERENCES public.departments(id);
...
-- Name: camp_service_pricing_rules camp_service_pricing_rules_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_service_pricing_rules
    ADD CONSTRAINT camp_service_pricing_rules_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id);

-- Name: camp_staff_roster camp_staff_roster_backup_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_staff_roster
    ADD CONSTRAINT camp_staff_roster_backup_employee_id_fkey FOREIGN KEY (backup_employee_id) REFERENCES public.employees(id);

-- Name: camp_staff_roster camp_staff_roster_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_staff_roster
    ADD CONSTRAINT camp_staff_roster_employee_id_fkey FOREIGN KEY (employee_id) REFERENCES public.employees(id);

-- Name: camp_supply_items camp_supply_items_batch_stock_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_supply_items
    ADD CONSTRAINT camp_supply_items_batch_stock_id_fkey FOREIGN KEY (batch_stock_id) REFERENCES public.pharmacy_batches(id);

-- Name: camp_supply_items camp_supply_items_catalog_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_supply_items
    ADD CONSTRAINT camp_supply_items_catalog_item_id_fkey FOREIGN KEY (catalog_item_id) REFERENCES public.pharmacy_catalog(id);

-- Name: camp_supply_items camp_supply_items_store_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.camp_supply_items
    ADD CONSTRAINT camp_supply_items_store_location_id_fkey FOREIGN KEY (store_location_id) REFERENCES public.store_locations(id);
...
-- Name: cancer_stagings cancer_stagings_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cancer_stagings
    ADD CONSTRAINT cancer_stagings_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id) ON DELETE CASCADE;

-- Name: cancer_stagings cancer_stagings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cancer_stagings
    ADD CONSTRAINT cancer_stagings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: caregiver_education caregiver_education_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.caregiver_education
    ADD CONSTRAINT caregiver_education_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: case_sheet_scans case_sheet_scans_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.case_sheet_scans
    ADD CONSTRAINT case_sheet_scans_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: clinical_corpus_entries clinical_corpus_entries_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clinical_corpus_entries
    ADD CONSTRAINT clinical_corpus_entries_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: clinical_corpus_entries clinical_corpus_entries_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clinical_corpus_entries
    ADD CONSTRAINT clinical_corpus_entries_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: clinical_corpus_entries clinical_corpus_entries_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.clinical_corpus_entries
    ADD CONSTRAINT clinical_corpus_entries_updated_by_fkey FOREIGN KEY (updated_by) REFERENCES public.users(id);
...
-- Name: clinical_trials clinical_trials_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: consent_records consent_records_trial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consent_records
    ADD CONSTRAINT consent_records_trial_id_fkey FOREIGN KEY (trial_id) REFERENCES public.clinical_trials(id);
...
-- Name: cpoe_safety_audit cpoe_safety_audit_checked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cpoe_safety_audit
    ADD CONSTRAINT cpoe_safety_audit_checked_by_fkey FOREIGN KEY (checked_by) REFERENCES public.users(id);

-- Name: cpoe_safety_audit cpoe_safety_audit_overridden_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cpoe_safety_audit
    ADD CONSTRAINT cpoe_safety_audit_overridden_by_fkey FOREIGN KEY (overridden_by) REFERENCES public.users(id);

-- Name: cpoe_safety_audit cpoe_safety_audit_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cpoe_safety_audit
    ADD CONSTRAINT cpoe_safety_audit_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: cpoe_safety_audit cpoe_safety_audit_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cpoe_safety_audit
    ADD CONSTRAINT cpoe_safety_audit_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: dental_chart_entries dental_chart_entries_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dental_chart_entries
    ADD CONSTRAINT dental_chart_entries_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: dental_exams dental_exams_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dental_exams
    ADD CONSTRAINT dental_exams_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id) ON DELETE CASCADE;

-- Name: dental_exams dental_exams_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dental_exams
    ADD CONSTRAINT dental_exams_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: device_pairing_requests device_pairing_requests_approved_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_requests
    ADD CONSTRAINT device_pairing_requests_approved_by_user_id_fkey FOREIGN KEY (approved_by_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: device_pairing_requests device_pairing_requests_approved_for_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_requests
    ADD CONSTRAINT device_pairing_requests_approved_for_user_id_fkey FOREIGN KEY (approved_for_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: device_pairing_requests device_pairing_requests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_requests
    ADD CONSTRAINT device_pairing_requests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: device_pairing_tokens device_pairing_tokens_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_tokens
    ADD CONSTRAINT device_pairing_tokens_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id);

-- Name: device_pairing_tokens device_pairing_tokens_intended_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_tokens
    ADD CONSTRAINT device_pairing_tokens_intended_user_id_fkey FOREIGN KEY (intended_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: device_pairing_tokens device_pairing_tokens_issued_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_tokens
    ADD CONSTRAINT device_pairing_tokens_issued_by_user_id_fkey FOREIGN KEY (issued_by_user_id) REFERENCES public.users(id) ON DELETE RESTRICT;

-- Name: device_pairing_tokens device_pairing_tokens_station_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_tokens
    ADD CONSTRAINT device_pairing_tokens_station_id_fkey FOREIGN KEY (station_id) REFERENCES public.stations(id);

-- Name: device_pairing_tokens device_pairing_tokens_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.device_pairing_tokens
    ADD CONSTRAINT device_pairing_tokens_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: dlt_templates dlt_templates_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dlt_templates
    ADD CONSTRAINT dlt_templates_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: ed_triage_entries ed_triage_entries_author_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ed_triage_entries
    ADD CONSTRAINT ed_triage_entries_author_user_id_fkey FOREIGN KEY (author_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: ed_triage_entries ed_triage_entries_er_visit_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ed_triage_entries
    ADD CONSTRAINT ed_triage_entries_er_visit_id_fkey FOREIGN KEY (er_visit_id) REFERENCES public.er_visits(id) ON DELETE CASCADE;

-- Name: ed_triage_entries ed_triage_entries_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ed_triage_entries
    ADD CONSTRAINT ed_triage_entries_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: fall_risk_interventions fall_risk_interventions_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fall_risk_interventions
    ADD CONSTRAINT fall_risk_interventions_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE CASCADE;

-- Name: fall_risk_interventions fall_risk_interventions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.fall_risk_interventions
    ADD CONSTRAINT fall_risk_interventions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: family_messages family_messages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.family_messages
    ADD CONSTRAINT family_messages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: health_package_bookings health_package_bookings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_package_bookings
    ADD CONSTRAINT health_package_bookings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: health_packages health_packages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_packages
    ADD CONSTRAINT health_packages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: home_care_packages home_care_packages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_care_packages
    ADD CONSTRAINT home_care_packages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_care_referrals home_care_referrals_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_care_referrals
    ADD CONSTRAINT home_care_referrals_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_discharge_program home_discharge_program_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_discharge_program
    ADD CONSTRAINT home_discharge_program_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_escalations home_escalations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_escalations
    ADD CONSTRAINT home_escalations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_med_administrations home_med_administrations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_med_administrations
    ADD CONSTRAINT home_med_administrations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_progress_notes home_progress_notes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_progress_notes
    ADD CONSTRAINT home_progress_notes_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: home_visits home_visits_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.home_visits
    ADD CONSTRAINT home_visits_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: hospice_enrollments hospice_enrollments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hospice_enrollments
    ADD CONSTRAINT hospice_enrollments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: hypoglycemia_events hypoglycemia_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.hypoglycemia_events
    ADD CONSTRAINT hypoglycemia_events_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: iam_access_requests iam_access_requests_requester_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.iam_access_requests
    ADD CONSTRAINT iam_access_requests_requester_id_fkey FOREIGN KEY (requester_id) REFERENCES public.users(id);

-- Name: iam_access_requests iam_access_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.iam_access_requests
    ADD CONSTRAINT iam_access_requests_reviewed_by_fkey FOREIGN KEY (reviewed_by) REFERENCES public.users(id);

-- Name: iam_access_requests iam_access_requests_revoked_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.iam_access_requests
    ADD CONSTRAINT iam_access_requests_revoked_by_fkey FOREIGN KEY (revoked_by) REFERENCES public.users(id);

-- Name: iam_access_requests iam_access_requests_target_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.iam_access_requests
    ADD CONSTRAINT iam_access_requests_target_user_id_fkey FOREIGN KEY (target_user_id) REFERENCES public.users(id);
...
-- Name: indwelling_devices indwelling_devices_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.indwelling_devices
    ADD CONSTRAINT indwelling_devices_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: invoice_items invoice_items_reversed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.invoice_items
    ADD CONSTRAINT invoice_items_reversed_by_fkey FOREIGN KEY (reversed_by) REFERENCES public.users(id);
...
-- Name: ipd_dama_records ipd_dama_records_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_dama_records
    ADD CONSTRAINT ipd_dama_records_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: ipd_discharge_tat_logs ipd_discharge_tat_logs_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_discharge_tat_logs
    ADD CONSTRAINT ipd_discharge_tat_logs_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: ipd_discharge_workflows ipd_discharge_workflows_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_discharge_workflows
    ADD CONSTRAINT ipd_discharge_workflows_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: ipd_mortality_reviews ipd_mortality_reviews_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_mortality_reviews
    ADD CONSTRAINT ipd_mortality_reviews_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: ipd_post_discharge_followups ipd_post_discharge_followups_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_post_discharge_followups
    ADD CONSTRAINT ipd_post_discharge_followups_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: ipd_post_discharge_followups ipd_post_discharge_followups_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ipd_post_discharge_followups
    ADD CONSTRAINT ipd_post_discharge_followups_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: long_term_medications long_term_medications_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.long_term_medications
    ADD CONSTRAINT long_term_medications_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: mds_assessments mds_assessments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mds_assessments
    ADD CONSTRAINT mds_assessments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: medication_reconciliation_items medication_reconciliation_items_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medication_reconciliation_items
    ADD CONSTRAINT medication_reconciliation_items_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: medication_reconciliations medication_reconciliations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.medication_reconciliations
    ADD CONSTRAINT medication_reconciliations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: microsite_config microsite_config_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.microsite_config
    ADD CONSTRAINT microsite_config_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_encounter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_encounter_id_fkey FOREIGN KEY (encounter_id) REFERENCES public.encounters(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_filed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_filed_by_fkey FOREIGN KEY (filed_by) REFERENCES public.users(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_generated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_generated_by_fkey FOREIGN KEY (generated_by) REFERENCES public.users(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_print_job_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_print_job_id_fkey FOREIGN KEY (print_job_id) REFERENCES public.print_jobs(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_printed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_printed_by_fkey FOREIGN KEY (printed_by) REFERENCES public.users(id);

-- Name: mrd_case_sheet_packets mrd_case_sheet_packets_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_packets
    ADD CONSTRAINT mrd_case_sheet_packets_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: mrd_case_sheet_pages mrd_case_sheet_pages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_case_sheet_pages
    ADD CONSTRAINT mrd_case_sheet_pages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: mrd_storage_locations mrd_storage_locations_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_storage_locations
    ADD CONSTRAINT mrd_storage_locations_created_by_fkey FOREIGN KEY (created_by) REFERENCES public.users(id);

-- Name: mrd_storage_locations mrd_storage_locations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mrd_storage_locations
    ADD CONSTRAINT mrd_storage_locations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: nabh_blood_transfusion_reactions nabh_blood_transfusion_reactions_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_blood_transfusion_reactions
    ADD CONSTRAINT nabh_blood_transfusion_reactions_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE SET NULL;

-- Name: nabh_blood_transfusion_reactions nabh_blood_transfusion_reactions_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_blood_transfusion_reactions
    ADD CONSTRAINT nabh_blood_transfusion_reactions_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: nabh_blood_transfusion_reactions nabh_blood_transfusion_reactions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_blood_transfusion_reactions
    ADD CONSTRAINT nabh_blood_transfusion_reactions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_bmw_disposal_log nabh_bmw_disposal_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_bmw_disposal_log
    ADD CONSTRAINT nabh_bmw_disposal_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_code_blue_activations nabh_code_blue_activations_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_code_blue_activations
    ADD CONSTRAINT nabh_code_blue_activations_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE SET NULL;

-- Name: nabh_code_blue_activations nabh_code_blue_activations_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_code_blue_activations
    ADD CONSTRAINT nabh_code_blue_activations_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: nabh_code_blue_activations nabh_code_blue_activations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_code_blue_activations
    ADD CONSTRAINT nabh_code_blue_activations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_equipment_downtime_log nabh_equipment_downtime_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_equipment_downtime_log
    ADD CONSTRAINT nabh_equipment_downtime_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_falls_register nabh_falls_register_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_falls_register
    ADD CONSTRAINT nabh_falls_register_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE SET NULL;

-- Name: nabh_falls_register nabh_falls_register_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_falls_register
    ADD CONSTRAINT nabh_falls_register_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: nabh_falls_register nabh_falls_register_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_falls_register
    ADD CONSTRAINT nabh_falls_register_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_fire_safety_drills nabh_fire_safety_drills_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_fire_safety_drills
    ADD CONSTRAINT nabh_fire_safety_drills_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_pressure_ulcer_assessments nabh_pressure_ulcer_assessments_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_pressure_ulcer_assessments
    ADD CONSTRAINT nabh_pressure_ulcer_assessments_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE CASCADE;

-- Name: nabh_pressure_ulcer_assessments nabh_pressure_ulcer_assessments_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_pressure_ulcer_assessments
    ADD CONSTRAINT nabh_pressure_ulcer_assessments_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: nabh_pressure_ulcer_assessments nabh_pressure_ulcer_assessments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_pressure_ulcer_assessments
    ADD CONSTRAINT nabh_pressure_ulcer_assessments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nabh_sentinel_event_register nabh_sentinel_event_register_admission_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_sentinel_event_register
    ADD CONSTRAINT nabh_sentinel_event_register_admission_id_fkey FOREIGN KEY (admission_id) REFERENCES public.admissions(id) ON DELETE SET NULL;

-- Name: nabh_sentinel_event_register nabh_sentinel_event_register_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_sentinel_event_register
    ADD CONSTRAINT nabh_sentinel_event_register_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: nabh_sentinel_event_register nabh_sentinel_event_register_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nabh_sentinel_event_register
    ADD CONSTRAINT nabh_sentinel_event_register_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
-- Name: nhcx_callback_log nhcx_callback_log_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nhcx_callback_log
    ADD CONSTRAINT nhcx_callback_log_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);

-- Name: nhcx_participants nhcx_participants_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nhcx_participants
    ADD CONSTRAINT nhcx_participants_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: nurse_shift_handoff_entries nurse_shift_handoff_entries_author_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nurse_shift_handoff_entries
    ADD CONSTRAINT nurse_shift_handoff_entries_author_user_id_fkey FOREIGN KEY (author_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: nurse_shift_handoff_entries nurse_shift_handoff_entries_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nurse_shift_handoff_entries
    ADD CONSTRAINT nurse_shift_handoff_entries_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id) ON DELETE SET NULL;

-- Name: nurse_shift_handoff_entries nurse_shift_handoff_entries_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nurse_shift_handoff_entries
    ADD CONSTRAINT nurse_shift_handoff_entries_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: nursing_shift_notes nursing_shift_notes_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nursing_shift_notes
    ADD CONSTRAINT nursing_shift_notes_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id) ON DELETE SET NULL;

-- Name: nursing_shift_notes nursing_shift_notes_last_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nursing_shift_notes
    ADD CONSTRAINT nursing_shift_notes_last_author_id_fkey FOREIGN KEY (last_author_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: nursing_shift_notes nursing_shift_notes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nursing_shift_notes
    ADD CONSTRAINT nursing_shift_notes_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: nutrition_screenings nutrition_screenings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nutrition_screenings
    ADD CONSTRAINT nutrition_screenings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: occ_health_exposures occ_health_exposures_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.occ_health_exposures
    ADD CONSTRAINT occ_health_exposures_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: ophtho_exams ophtho_exams_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ophtho_exams
    ADD CONSTRAINT ophtho_exams_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id) ON DELETE CASCADE;

-- Name: ophtho_exams ophtho_exams_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ophtho_exams
    ADD CONSTRAINT ophtho_exams_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: paired_devices paired_devices_department_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paired_devices
    ADD CONSTRAINT paired_devices_department_id_fkey FOREIGN KEY (department_id) REFERENCES public.departments(id);

-- Name: paired_devices paired_devices_issued_to_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paired_devices
    ADD CONSTRAINT paired_devices_issued_to_user_id_fkey FOREIGN KEY (issued_to_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: paired_devices paired_devices_revoked_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paired_devices
    ADD CONSTRAINT paired_devices_revoked_by_user_id_fkey FOREIGN KEY (revoked_by_user_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: paired_devices paired_devices_station_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.paired_devices
    ADD CONSTRAINT paired_devices_station_id_fkey FOREIGN KEY (station_id) REFERENCES public.stations(id);
...
-- Name: patient_clinical_notes patient_clinical_notes_last_author_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.patient_clinical_notes
    ADD CONSTRAINT patient_clinical_notes_last_author_id_fkey FOREIGN KEY (last_author_id) REFERENCES public.users(id) ON DELETE SET NULL;

-- Name: patient_clinical_notes patient_clinical_notes_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.patient_clinical_notes
    ADD CONSTRAINT patient_clinical_notes_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id) ON DELETE CASCADE;

-- Name: patient_clinical_notes patient_clinical_notes_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.patient_clinical_notes
    ADD CONSTRAINT patient_clinical_notes_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: payment_terminals payment_terminals_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.payment_terminals
    ADD CONSTRAINT payment_terminals_location_id_fkey FOREIGN KEY (location_id) REFERENCES public.locations(id);
...
-- Name: payslips payslips_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
-- Name: pharmacy_order_items pharmacy_order_items_removed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pharmacy_order_items
    ADD CONSTRAINT pharmacy_order_items_removed_by_fkey FOREIGN KEY (removed_by) REFERENCES public.users(id);
...
-- Name: pharmacy_pos_sales pharmacy_pos_sales_billing_invoice_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.pharmacy_pos_sales
    ADD CONSTRAINT pharmacy_pos_sales_billing_invoice_id_fkey FOREIGN KEY (billing_invoice_id) REFERENCES public.invoices(id);
...
-- Name: radiation_sessions radiation_sessions_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.radiation_sessions
    ADD CONSTRAINT radiation_sessions_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id) ON DELETE CASCADE;

-- Name: radiation_sessions radiation_sessions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.radiation_sessions
    ADD CONSTRAINT radiation_sessions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: readmission_risk_assessments readmission_risk_assessments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.readmission_risk_assessments
    ADD CONSTRAINT readmission_risk_assessments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: rehab_progress rehab_progress_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rehab_progress
    ADD CONSTRAINT rehab_progress_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: remote_vital_readings remote_vital_readings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remote_vital_readings
    ADD CONSTRAINT remote_vital_readings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: seo_settings seo_settings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.seo_settings
    ADD CONSTRAINT seo_settings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: sepsis_hour1_bundles sepsis_hour1_bundles_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sepsis_hour1_bundles
    ADD CONSTRAINT sepsis_hour1_bundles_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: simulator_run_findings simulator_run_findings_run_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.simulator_run_findings
    ADD CONSTRAINT simulator_run_findings_run_id_fkey FOREIGN KEY (run_id) REFERENCES public.simulator_runs(id) ON DELETE CASCADE;

-- Name: site_domains site_domains_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.site_domains
    ADD CONSTRAINT site_domains_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: snf_admissions snf_admissions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.snf_admissions
    ADD CONSTRAINT snf_admissions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: staff_location_assignments staff_location_assignments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_location_assignments
    ADD CONSTRAINT staff_location_assignments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: stations stations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.stations
    ADD CONSTRAINT stations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: tele_chat_messages tele_chat_messages_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tele_chat_messages
    ADD CONSTRAINT tele_chat_messages_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: tele_consultations tele_consultations_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tele_consultations
    ADD CONSTRAINT tele_consultations_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id);

-- Name: tele_triage tele_triage_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tele_triage
    ADD CONSTRAINT tele_triage_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: transfusion_observations transfusion_observations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.transfusion_observations
    ADD CONSTRAINT transfusion_observations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: trial_adverse_events trial_adverse_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_adverse_events
    ADD CONSTRAINT trial_adverse_events_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: trial_adverse_events trial_adverse_events_trial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_adverse_events
    ADD CONSTRAINT trial_adverse_events_trial_id_fkey FOREIGN KEY (trial_id) REFERENCES public.clinical_trials(id) ON DELETE CASCADE;

-- Name: trial_irb_submissions trial_irb_submissions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_irb_submissions
    ADD CONSTRAINT trial_irb_submissions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: trial_irb_submissions trial_irb_submissions_trial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_irb_submissions
    ADD CONSTRAINT trial_irb_submissions_trial_id_fkey FOREIGN KEY (trial_id) REFERENCES public.clinical_trials(id) ON DELETE CASCADE;

-- Name: trial_randomizations trial_randomizations_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_randomizations
    ADD CONSTRAINT trial_randomizations_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: trial_randomizations trial_randomizations_trial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_randomizations
    ADD CONSTRAINT trial_randomizations_trial_id_fkey FOREIGN KEY (trial_id) REFERENCES public.clinical_trials(id) ON DELETE CASCADE;

-- Name: trial_visits trial_visits_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_visits
    ADD CONSTRAINT trial_visits_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: trial_visits trial_visits_trial_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trial_visits
    ADD CONSTRAINT trial_visits_trial_id_fkey FOREIGN KEY (trial_id) REFERENCES public.clinical_trials(id) ON DELETE CASCADE;
...
-- Name: user_pharmacy_assignments user_pharmacy_assignments_store_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_pharmacy_assignments
    ADD CONSTRAINT user_pharmacy_assignments_store_location_id_fkey FOREIGN KEY (store_location_id) REFERENCES public.store_locations(id) ON DELETE CASCADE;

-- Name: user_pharmacy_assignments user_pharmacy_assignments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_pharmacy_assignments
    ADD CONSTRAINT user_pharmacy_assignments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: user_pharmacy_assignments user_pharmacy_assignments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_pharmacy_assignments
    ADD CONSTRAINT user_pharmacy_assignments_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
-- Name: vpn_devices vpn_devices_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vpn_devices
    ADD CONSTRAINT vpn_devices_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: vpn_devices vpn_devices_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vpn_devices
    ADD CONSTRAINT vpn_devices_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;

-- Name: vte_risk_assessments vte_risk_assessments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.vte_risk_assessments
    ADD CONSTRAINT vte_risk_assessments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
-- Name: ward_par_levels ward_par_levels_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ward_par_levels
    ADD CONSTRAINT ward_par_levels_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

-- Name: ward_stock ward_stock_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.ward_stock
    ADD CONSTRAINT ward_stock_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;

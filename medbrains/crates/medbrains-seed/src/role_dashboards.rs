...
const DOCTOR_WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        ...
        subtitle: "Encounters assigned to you today",
        ...
        perm: "opd.visit.list",
        sort: 1,
        refresh_ms: Some(30000),
    },
    WidgetDef {
        wtype: "stat_card",
        title: "My Pending Labs",
        subtitle: "Lab orders awaiting results",
        icon: "IconFlask",
        color: "orange",
        config: r#"{"format": "number"}"#,
    ...
    WidgetDef {
        wtype: "data_table",
        title: "My OPD Queue",
        subtitle: "Your current waiting list",
        icon: "IconList",
        color: "teal",
...
const NURSE_WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        wtype: "stat_card",
        title: "Ward Patients",
        subtitle: "Active admissions in your department",
        icon: "IconBed",
        color: "indigo",
        config: r#"{"format": "number"}"#,
    ...
    WidgetDef {
        wtype: "stat_card",
        title: "Bed Occupancy",
        subtitle: "Current bed occupancy",
    ...
    WidgetDef {
        ...
        subtitle: "Upcoming medication administrations",
        icon: "IconPill",
        color: "red",
    ...
    WidgetDef {
        ...
        subtitle: "Latest IPD admissions",
        icon: "IconBed",
        color: "indigo",
...
const RECEPTIONIST_WIDGETS: &[WidgetDef] = &[
    ...
    WidgetDef {
        wtype: "stat_card",
        title: "OPD Queue",
        subtitle: "Current waiting patients",
        icon: "IconStethoscope",
        color: "teal",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "module_query", "module": "opd", "query": "queue_count"}"#,
    ...
    WidgetDef {
        ...
        subtitle: "Pending invoice payments",
        icon: "IconReceipt",
        color: "orange",
        config: r#"{"format": "number"}"#,
...
const LAB_TECH_WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        ...
        subtitle: "Lab orders awaiting processing",
        icon: "IconFlask",
        color: "orange",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "module_query", "module": "lab", "query": "pending_count"}"#,
    ...
    WidgetDef {
        ...
        subtitle: "Lab orders completed today",
        icon: "IconCheck",
        color: "green",
        config: r#"{"format": "number"}"#,
    ...
    WidgetDef {
        wtype: "stat_card",
        title: "Lab TAT",
        subtitle: "Average turnaround time today",
        icon: "IconClock",
        color: "cyan",
        ...
        perm: "lab.orders.list",
        sort: 3,
        refresh_ms: Some(120000),
    },
    WidgetDef {
        wtype: "stat_card",
        title: "QC Pending",
        subtitle: "QC results needing review",
        icon: "IconShield",
        color: "red",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "module_query", "module": "lab", "query": "pending_count"}"#,
    ...
    WidgetDef {
        ...
        subtitle: "Samples pending collection",
        icon: "IconDroplet",
        color: "red",
    ...
    WidgetDef {
        ...
        subtitle: "Latest completed lab results",
        icon: "IconTestPipe",
        color: "orange",
...
const PHARMACIST_WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        ...
        w: 3,
        h: 2,
        perm: "pharmacy.prescriptions.list",
        sort: 1,
        refresh_ms: Some(15000),
    },
    WidgetDef {
        ...
        subtitle: "Orders dispensed today",
        icon: "IconCheck",
        color: "teal",
        config: r#"{"format": "number"}"#,
    ...
    WidgetDef {
        wtype: "list",
        title: "Stock Alerts",
        subtitle: "Low stock and near-expiry drugs",
        ...
        w: 4,
        h: 4,
        perm: "pharmacy.stock.manage",
        sort: 5,
        refresh_ms: Some(300000),
    },
    WidgetDef {
        wtype: "data_table",
        title: "NDPS Register",
        subtitle: "Recent controlled substance entries",
        icon: "IconShield",
        color: "red",
...
const BILLING_WIDGETS: &[WidgetDef] = &[
    ...
    WidgetDef {
        wtype: "stat_card",
        title: "Day Close",
        subtitle: "Today's day-end close status",
    ...
    WidgetDef {
        ...
        icon: "IconTrendingUp",
        color: "green",
        config: r#"{"chart_type": "line", "x_axis": "date", "y_axis": "amount", "sensitive": {"amount": "billing.amount"}}"#,
        data_source: r#"{"type": "module_query", "module": "billing", "query": "revenue_summary"}"#,
        x: 6,
        y: 2,
        w: 6,
...
const FACILITIES_WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        ...
        w: 3,
        h: 2,
        perm: "facilities.work_orders.list",
        sort: 1,
        refresh_ms: Some(60000),
    },
    WidgetDef {
        ...
        subtitle: "Indents awaiting approval",
        icon: "IconFileText",
        color: "blue",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "module_query", "module": "billing", "query": "pending_invoices"}"#,
    ...
    WidgetDef {
        ...
        w: 3,
        h: 2,
        perm: "hr.attendance.list",
        sort: 4,
        refresh_ms: Some(300000),
    },
    WidgetDef {
        wtype: "list",
        title: "Equipment PM Due",
        subtitle: "Preventive maintenance due within 7 days",
        icon: "IconSettings",
        color: "red",
    ...
    WidgetDef {
        ...
        subtitle: "Expiring licenses and compliance items",
        icon: "IconAlertTriangle",
        color: "yellow",
        ...
        w: 6,
        h: 4,
        perm: "facilities.compliance.list",
        sort: 6,
        refresh_ms: Some(300000),
    },
    WidgetDef {
...
const ADMIN_WIDGETS: &[WidgetDef] = &[
    ...
    WidgetDef {
        wtype: "system_health",
        title: "System Health",
        subtitle: "API and database health",
        icon: "IconServer",
        color: "green",
        config: r"{}",

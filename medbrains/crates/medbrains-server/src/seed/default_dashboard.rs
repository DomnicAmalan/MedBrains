...
const WIDGETS: &[WidgetDef] = &[
    WidgetDef {
        ...
        x: 0, y: 0, w: 3, h: 2, perm: "patients.list", sort: 1,
    },
    WidgetDef {
        wtype: "stat_card", title: "Today's OPD", subtitle: "OPD encounters today",
        icon: "IconStethoscope", color: "teal",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "sql_count", "table": "encounters", "filter": "DATE(encounter_date) = CURRENT_DATE"}"#,
        x: 3, y: 0, w: 3, h: 2, perm: "opd.queue.list", sort: 2,
    },
    WidgetDef {
        ...
        x: 6, y: 0, w: 3, h: 2, perm: "ipd.admissions.list", sort: 3,
    },
    WidgetDef {
        wtype: "stat_card", title: "Pending Lab Orders", subtitle: "Unprocessed lab orders",
        icon: "IconFlask", color: "red",
        config: r#"{"format": "number"}"#,
        data_source: r#"{"type": "sql_count", "table": "lab_orders", "filter": "status IN ('ordered','sample_collected')"}"#,
        x: 9, y: 0, w: 3, h: 2, perm: "lab.orders.list", sort: 4,
    },
    WidgetDef {
        ...
        x: 0, y: 2, w: 6, h: 4, perm: "opd.queue.list", sort: 5,
    },
    WidgetDef {
        wtype: "data_table", title: "Recent Admissions", subtitle: "Last 10 IPD admissions",
        icon: "IconBed", color: "orange",
        ...
        x: 6, y: 2, w: 6, h: 4, perm: "ipd.admissions.list", sort: 6,
    },
    WidgetDef {
        ...
        x: 0, y: 6, w: 6, h: 3, perm: "billing.invoices.list", sort: 7,
    },
    WidgetDef {
        ...
        x: 6, y: 6, w: 6, h: 3, perm: "dashboard.view", sort: 8,
    },
];

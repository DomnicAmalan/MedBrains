...
const DEMO_DOCTORS: &[DemoDoctor] = &[
    ...
    DemoDoctor {
        ...
        email: "dr_fatima@medbrains.local",
        dept_code: "OBGYN",
    },
    DemoDoctor {
        username: "dr_sandeep",
        full_name: "Dr. Sandeep Iyer",
        email: "dr_sandeep@medbrains.local",
        dept_code: "ORTHOPEDICS",
    },
    DemoDoctor {
        username: "dr_meera",
        full_name: "Dr. Meera Iqbal",
        email: "dr_meera@medbrains.local",
        dept_code: "EMERGENCY",
    },
    DemoDoctor {
        username: "dr_asha",
        full_name: "Dr. Asha Thomas",
        email: "dr_asha@medbrains.local",
        dept_code: "ICU",
    },
];
...
const DEMO_ROLE_USERS: &[DemoRoleUser] = &[
    ...
    DemoRoleUser {
        ...
        email: "nurse_beena@medbrains.local",
        role: "nurse",
        dept_code: Some("GEN-MEDICINE"),
    },
    DemoRoleUser {
        ...
        email: "nurse_chitra@medbrains.local",
        role: "nurse",
    ...
    DemoRoleUser {
        ...
        email: "nurse_david@medbrains.local",
        role: "nurse",
    ...
    DemoRoleUser {
        ...
        email: "nurse_farida@medbrains.local",
        role: "nurse",
    ...
    DemoRoleUser {
        ...
        email: "charge_latha@medbrains.local",
        role: "nurse",
        dept_code: Some("ICU"),
    },
    DemoRoleUser {
        ...
        email: "nurse_rahul@medbrains.local",
        role: "nurse",
    ...
    DemoRoleUser {
        ...
        email: "nurse_mina@medbrains.local",
        role: "nurse",
        dept_code: Some("PEDIATRICS"),
    },
    DemoRoleUser {

...
export const ACCESS_MATRIX_WORKFLOW_EXPECTATIONS: readonly AccessMatrixWorkflowExpectation[] = [
  ...
  {
    key: "indent_inventory",
    label: "Indent and store inventory",
    modules: ["indent"],
    requiredKinds: ["screen", "tab", "table", "input", "action", "widget"],
  },
  {
    key: "billing",
    label: "Billing",
...
const INDENT_REQUISITION_FIELDS = [
  "indent.requisitions.indent_number",
  "indent.requisitions.department_id",
  "indent.requisitions.status",
  "indent.requisitions.total_amount",
  "indent.items.quantity_requested",
  "indent.items.quantity_approved",
] as const;

const INDENT_STOCK_FIELDS = [
  ...INDENT_REQUISITION_FIELDS,
  "indent.stock_movements.quantity",
] as const;
...
export const ACCESS_MATRIX_SURFACES: readonly AccessMatrixSurface[] = [
  ...
  surface({
    ...
    fieldAccessKeys: PATIENT_IDENTITY_FIELDS,
    masking: "identity",
    activatesAfter: ["patient.created", "patient.card_printed"],
    platforms: ["web", "mobile"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["opd.encounter.created", "opd.consultation.started"],
    platforms: ["web", "mobile"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["opd.encounter.created", "opd.consultation.started", "opd.vitals.recorded"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["opd.encounter.created", "opd.vitals.recorded", "opd.consultation.saved"],
  ...
  surface({
    ...
    fieldAccessKeys: [...PATIENT_IDENTITY_FIELDS, "ipd.admissions.provisional_diagnosis"],
    masking: "clinical",
    activatesAfter: ["ipd.admission.created", "bed.assigned", "bed.transferred"],
    platforms: ["web", "mobile"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["ipd.discharge.initiated", "ipd.discharge.completed"],
  ...
  surface({
    ...
    fieldAccessKeys: CAMP_REGISTRATION_FIELDS,
    masking: "clinical",
    activatesAfter: ["camp.registration.created", "camp.screening.completed"],
    platforms: ["web", "mobile"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["order.created", "pharmacy.prescription.reviewed", "order.cancelled"],
    platforms: ["web", "mobile", "tv"],
  ...
  surface({
    id: "indent.requisitions.screen",
    module: "indent",
    area: "Indent and Store",
    label: "Indent requisition workspace",
    kind: "screen",
    route: "/indent",
    table: "indent_requisitions",
    requiredPermissions: [P.INDENT.LIST],
    fieldAccessKeys: INDENT_REQUISITION_FIELDS,
    masking: "operational",
    activatesAfter: [
    ...
    platforms: ["web", "mobile"],
    standardRefs: ["NABH inventory control", "department store accountability"],
  }),
  surface({
    id: "indent.operations.tabs",
    module: "indent",
    area: "Indent and Store",
    label: "My indents, approvals, stock, analytics and patient consumables tabs",
    kind: "tab",
    route: "/indent#my-indents",
    tab: "my-indents",
    requiredPermissions: [P.INDENT.LIST, P.INDENT.STOCK_MANAGE],
    fieldAccessKeys: INDENT_STOCK_FIELDS,
    masking: "operational",
    activatesAfter: [
      "indent.requisition.submitted",
      "indent.requisition.approved",
    ...
    platforms: ["web", "mobile"],
    standardRefs: ["NABH material management", "stock movement traceability"],
  }),
  surface({
    id: "indent.requisitions.table",
    module: "indent",
    area: "Indent and Store",
    label: "Indent number, department, status and amount table",
    kind: "table",
    route: "/indent",
    table: "indent_requisitions",
    requiredPermissions: [P.INDENT.LIST],
    ...
    platforms: ["web", "mobile"],
    standardRefs: ["department indent audit trail"],
  }),
  surface({
    id: "indent.requisition.inputs",
    module: "indent",
    area: "Indent and Store",
    label: "Department, indent type, priority and item quantity inputs",
    kind: "input",
    route: "/indent#new",
    requiredPermissions: [P.INDENT.CREATE],
    fieldAccessKeys: INDENT_REQUISITION_FIELDS,
    masking: "operational",
    platforms: ["web", "mobile"],
    standardRefs: ["controlled store requisition capture"],
  }),
  surface({
    id: "indent.approval_issue.actions",
    module: "indent",
    area: "Indent and Store",
    label: "Submit, approve, reject and issue indent actions",
    kind: "action",
    route: "/indent/:requisitionId",
    requiredPermissions: [P.INDENT.VIEW, P.INDENT.APPROVE, P.INDENT.STOCK_MANAGE],
    fieldAccessKeys: INDENT_STOCK_FIELDS,
    masking: "operational",
    activatesAfter: [
      "indent.requisition.submitted",
    ...
    platforms: ["web", "mobile"],
    standardRefs: ["approval segregation", "stock issue audit trail"],
  }),
  surface({
    id: "indent.analytics.widgets",
    module: "indent",
    area: "Indent and Store",
    label: "Consumption, ABC/VED/FSN, dead-stock and valuation widgets",
    kind: "widget",
    route: "/indent#analytics",
    requiredPermissions: [P.INDENT.LIST, P.INDENT.STOCK_MANAGE],
    fieldAccessKeys: INDENT_STOCK_FIELDS,
    masking: "operational",
    activatesAfter: [
    ...
    platforms: ["web", "tv"],
    standardRefs: ["NABH material management indicators", "inventory valuation controls"],
  }),
  surface({
  ...
  surface({
    ...
    masking: "operational",
    activatesAfter: ["pharmacy.stock.movement.created"],
  ...
  surface({
    ...
    masking: "clinical",
    activatesAfter: ["pharmacy.prescription.reviewed", "pharmacy.order.dispensed"],
    platforms: ["web", "mobile"],
    printArtifacts: [
      "Dispense receipt",
      "Drug label",

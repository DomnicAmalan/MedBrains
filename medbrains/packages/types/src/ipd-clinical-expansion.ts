...
export interface CampScreening {
  ...
  /** Tick boxes on the paper form. `null` means not asked, which is not the
   * same fact as `false` — a screening camp cannot treat an unasked question
   * as a negative finding. */
  mh_diabetes: boolean | null;
  mh_hypertension: boolean | null;
  mh_asthma: boolean | null;
  mh_heart_disease: boolean | null;
  mh_thyroid_disorder: boolean | null;
  mh_previous_surgeries: boolean | null;
  mh_allergies: boolean | null;
  mh_smoking_history: boolean | null;
  mh_alcohol_use: boolean | null;
  mh_family_history: boolean | null;
  mh_others: boolean | null;
  medical_history_notes: string | null;
  test_hba1c: number | null;
  test_haemoglobin: number | null;
  test_thyroid: number | null;
  test_ecg: string | null;
  test_xray: string | null;
  test_bmd: string | null;
  test_biothesiometry: string | null;
  findings: string | null;
...
export interface CreateCampScreeningRequest {
  ...
  test_hba1c?: number;
  test_haemoglobin?: number;
  test_thyroid?: number;
  test_ecg?: string;
  test_xray?: string;
  test_bmd?: string;
  test_biothesiometry?: string;
